...
func (s *Server) setupRoutes() {
	...
	api := s.router.Group("/api")
	{
		...
		protected := api.Group("/", s.authMiddleware())
		{
			...
			protected.POST("/strategies/ai-council", s.handleStartStrategyAICouncil)
			protected.GET("/strategies/ai-council/:id", s.handleGetStrategyAICouncil)
			protected.POST("/strategies/ai-council/:id/cancel", s.handleCancelStrategyAICouncil)
...
func (s *Server) handleKlines(c *gin.Context) {
	...
	case "hyperliquid":
		// Hyperliquid native API for crypto perps
...
func (s *Server) handleSymbols(c *gin.Context) {
	...
	type SymbolInfo struct {
		...
		Name        string `json:"name"`
		Category    string `json:"category"` // crypto
	...
	case "hyperliquid":
		// Fetch crypto perp symbols from Hyperliquid
