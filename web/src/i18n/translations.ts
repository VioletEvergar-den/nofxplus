...
export const translations = {
  en: {
    ...
    aiCouncil: {
      ...
      budgetHint: 'Max AI calls for the whole session (5-40, default 12). Each tool query counts; AI sees remaining budget',
  ...
  zh: {
    ...
    aiCouncil: {
      ...
      budgetHint: '全场 AI 调用上限（5-40，默认12）。工具查询也计入；AI 每次发言都能看到剩余预算',
      budgetUsage: '预算已用',
      meetTeam: '专家团阵容',
      liveFeed: '实时圆桌',
      thinking: '专家正在思考…',
