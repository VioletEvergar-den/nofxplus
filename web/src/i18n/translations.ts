...
export const translations = {
  en: {
    ...
    aiCouncil: {
      ...
      budgetHint: 'Max AI calls (5-200, default 12). Tool queries count; AI sees remaining budget. More budget = deeper debate',
  ...
  zh: {
    ...
    aiCouncil: {
      ...
      budgetHint: 'AI 调用上限（5-200，默认12）。工具查询也计入；预算越足，专家讨论越深入',
      budgetUsage: '预算已用',
      aiNamed: '专家团为策略命名',
      addToList: '添加到策略列表',
      addedToList: '已添加到列表！',
