...
export const translations = {
  en: {
    ...
    probeCapabilities: 'Detect Capabilities',
    probing: 'Probing…',
    ...
    aiCouncil: {
      ...
      subtitle: '5 expert roles collaborate in a roundtable to generate / modify your strategy',
      ...
      modelLabel: 'AI Model',
      start: 'Convene Council',
      running: 'Council in session...',
      cancel: 'Cancel',
      searchOn: 'Web search: enabled (SearXNG)',
      searchOff: 'Web search: not configured (SEARXNG_URL not set)',
      round1: 'Round 1 · Intel & Trading Plan',
      round2: 'Round 2 · Architecture & Review',
      round3: 'Round 3 · Prompt Writing',
      promptGenerated: 'System Prompt strategy generated (4 sections)',
      promptGeneratedNote: 'After applying, view and edit the full prompt in the "Prompt Editor" tab',
      pending: 'Pending',
      ...
      concerns: 'Objections',
      sources: 'Sources',
      resultTitle: 'Final Strategy Proposal',
      reasoning: 'Chief Reviewer Summary',
      clampWarnings: 'Auto-corrections by program review',
      repairRounds: 'Format-review repair rounds',
      scanSuggestion: 'Suggested scan interval',
      scanSuggestionNote: 'Scan interval is a trader-level setting. Apply it in trader config after adopting this strategy.',
      apply: 'Apply to Editor',
      applied: 'Applied! Remember to save the strategy.',
      councilFailed: 'Council failed',
      needModel: 'Please select an AI model first',
      needIntent: 'Please describe your strategy intent',
      minutes: 'min',
      roles: {
        intel_planner: 'Intel Planner',
        intel_analyst: 'Intel Analyst',
        market_analyst: 'Market Analyst',
        coin_researcher: 'Coin Researcher',
        chief_trader: 'Chief Trader',
        strategy_architect: 'Strategy Architect',
        timeframe_engineer: 'Timeframe Engineer',
        coin_planner: 'Coin Planner',
        risk_officer: 'Risk Officer',
        risk_reviewer: 'Risk Reviewer',
        chief_reviewer: 'Chief Reviewer',
        prompt_writer: 'Chief Prompt Writer',
      },
      budgetLabel: 'Agent call budget',
      budgetHint: 'More budget = deeper debate',
      capitalLabel: 'Capital (USDT)',
      capitalPlaceholder: 'e.g. 10',
      capitalHint: 'Experts verify min order size: capital × leverage must cover the coin minimum (BTC ≥ 100U)',
      styleLabel: 'Prompt style',
      styleOption: { auto: 'Auto', concise: 'Concise', balanced: 'Balanced', detailed: 'Detailed' },
      styleHint: {
        auto: 'AI decides complexity by strategy type',
        concise: 'One line per section, core persona only',
        balanced: '2-4 sentences per section with key rules',
        detailed: 'Full executable rules with concrete numbers',
      },
      budgetUsage: 'Budget used',
      aiNamed: 'Strategy named by the council',
      addToList: 'Add to strategy list',
      addedToList: 'Added to list!',
      meetTeam: 'Meet the Expert Team',
      liveFeed: 'Live Roundtable',
      thinking: 'Experts are thinking...',
      roster: 'Expert Roster',
      ctaTitle: 'AI Expert Council',
      ctaDesc: 'Live multi-expert roundtable · auto data lookup',
      roleIntro: {
        intel_analyst: 'Searches web news and pulls real klines on its own to build the market intelligence brief',
        chief_trader: 'Battle-hardened futures trader: reads real klines and issues the actionable trading plan',
        strategy_architect: 'Translates the trading plan into concrete strategy parameters with multi-timeframe checks',
        risk_reviewer: 'Independent risk gatekeeper: reviews everything and can call out any expert for follow-up',
        prompt_writer: 'Distills the whole roundtable into a ready-to-trade System Prompt strategy',
      },
    },
  },
  zh: {
    ...
    aiCouncil: {
      ...
      running: '专家团圆桌进行中...',
      cancel: '取消圆桌',
      searchOn: '联网搜索：已启用（SearXNG）',
      searchOff: '联网搜索：未配置（SEARXNG_URL 未设置）',
      round1: '第一轮 · 情报与交易计划',
      round2: '第二轮 · 架构与风控评审',
      round3: '第三轮 · 提示词撰写',
      promptGenerated: '已生成 System Prompt 策略（四段）',
      promptGeneratedNote: '应用后在「Prompt 编辑」页签查看和修改完整提示词',
      pending: '等待中',
      runningStep: '思考中...',
      doneStep: '完成',
      failedStep: '失败',
      ...
      resultTitle: '最终策略方案',
      reasoning: '首席评审总结',
      clampWarnings: '程序审核自动修正',
      repairRounds: '格式审核修复轮次',
      scanSuggestion: '扫描周期建议',
      scanSuggestionNote: '扫描周期属于交易员级配置，采纳策略后请在交易员设置中同步调整。',
      apply: '应用到编辑器',
      applied: '已应用！请记得保存策略。',
      councilFailed: '圆桌失败',
      needModel: '请先选择 AI 模型',
      needIntent: '请先描述策略意图',
      minutes: '分钟',
      roles: {
        intel_planner: '情报规划',
        market_analyst: '宏观分析师',
        coin_researcher: '币种研究员',
        intel_analyst: '情报分析师',
        chief_trader: '首席合约交易员',
        strategy_architect: '策略架构师',
        timeframe_engineer: '周期指标工程师',
        coin_planner: '币种来源规划师',
        risk_officer: '风控官',
        risk_reviewer: '风控评审官',
        chief_reviewer: '首席评审',
        prompt_writer: '首席策略撰写官',
      },
      budgetLabel: 'Agent 调用预算',
      budgetHint: '预算越足，专家讨论越深入',
      capitalLabel: '本金 (USDT)',
      capitalPlaceholder: '例如 10',
      capitalHint: '专家会校验最小开仓：本金×杠杆需覆盖币种最小名义（BTC≥100U），开不起仓的币会被排除',
      styleLabel: '提示词风格',
      styleOption: { auto: '自动', concise: '简洁', balanced: '均衡', detailed: '复杂' },
      styleHint: {
        auto: 'AI 按策略类型自行决定复杂度',
        concise: '每段一句话，只抓核心人设与理念',
        balanced: '每段2~4句，含关键入场信号与纪律',
        detailed: '完整可执行规则，含具体执行数字',
      },
      budgetUsage: '预算已用',
      aiNamed: '专家团为策略命名',
      addToList: '添加到策略列表',
      ...
      roster: '专家名册',
      ctaTitle: 'AI 专家团',
      ctaDesc: '5 专家实时圆桌 · 自主查数据',
      roleIntro: {
        intel_analyst: '自主联网搜索资讯、拉取真实K线，产出市场情报简报',
        chief_trader: '身经百战的合约交易员：查看真实K线后给出实战交易计划',
        strategy_architect: '把交易计划翻译成具体策略参数，逐周期校验多周期趋势',
        risk_reviewer: '独立风控守门人：审查全部结论，可点名追问任何专家',
        prompt_writer: '汇总整场圆桌，撰写可直接实盘的 System Prompt 策略',
      },
    },
  },
}
